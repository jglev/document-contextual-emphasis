...
- **Change history is preserved.** Because documents are written in Markdown, their history of changes can be saved using [Git](https://guides.github.com/introduction/git-handbook/), the technology on which [GitHub](https://guides.github.com/activities/hello-world/) is built.
